...
if(isset($_POST['upload'])){
    ...
    if($result->num_rows>0){
        $insert=$conn->prepare("INSERT INTO `lostitems`(`Name`, `USN`, `Dept`, `Contact`, `Email`,`itemname`, `category`, `Description`, `imgpath`, `addet`) VALUES (?,?,?,?,?,?,?,?,?,?)");
        $insert->bind_param("ssssssssss",$name,$usn,$dept,$contact,$email,$itemname,$category,$desc,$imgpath,$addet);
        $insert->execute();
        ...
        echo "Lost Item details submitted successfully.";
    }
    else{
...
<head>
    ...
    <title>Report For Lost- R Y M E C</title>
...
<body>
    ...
    <div class="form-head">
    <h2>Report For The Lost</h2>
    </div>
    <div class="form-container">
        <form action="reportlost.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="desc" rows="4" cols="30" placeholder="Describe details about your lost item like color,brand,features,etc."></textarea>
            </div><br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="addet" cols="30" rows="4" placeholder="Any additional details like where,when,how it was lost."></textarea>
            </div><br>
            <button type="submit" name="upload" value="upload">Post</button>
        </form>
    </div>
    <br><br>
    <div>
